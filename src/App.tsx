...
import type { Root } from "../types/GithubRelease";
  ...
  return (
    <div className="App flex flex-col items-center justify-center p-4">
      <header className="border-b-2 w-full pb-4 border-dotted">
        <h3 className="text-3xl font-extrabold text-red-400">ReVanced Apps</h3>
      </header>
      <div className="px-2 py-4 w-auto h-100">
        <div className="flex flex-col md:flex-row ">
          <div className="flex flex-col space-y-2 md:pl-3">
            ...
            <p className="text-gray-300 max-w-lg text-xs">
              If you are having problems with latest version of release,
              download previous releases from our{" "}
              <a href="https://t.me/revanced_apks_web">Telegram channel</a> or{" "}
              <a href="https://github.com/revanced-apks/build-apps/releases">
                GitHub releases
              </a>
              .
            </p>
        ...
        <div className="flex flex-col justify-center items-center mt-6 border border-gray-400 p-4 rounded-3xl bg-gray-900">
          ...
          <p className="pt-2 text-sm">
            This project is open source, forked from{" "}
          ...
          <p>
            Join our <a href="https://t.me/revanced_apks_web">Telegram</a> for
            release updates.
          </p>
        </div>
      </div>
